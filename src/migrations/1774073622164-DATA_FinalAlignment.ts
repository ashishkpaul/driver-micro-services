...
/**
 * INTENT:    Phase 24 of 47 — Column "driver_id" requires backfill before NOT NULL can be enforced
 * TYPE:      DATA
 * RISK:      MEDIUM
 * ROLLBACK:  SAFE
 * *
...
export class DATAFinalAlignment1774073622164 implements MigrationInterface {
  name = 'DATAFinalAlignment1774073622164';
