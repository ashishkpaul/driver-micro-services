...
/**
 * INTENT:    Phase 27 of 47 — Enforce NOT NULL on "driver_id" after data is backfilled
 * TYPE:      BREAKING
 * RISK:      HIGH
 * ROLLBACK:  DATA_LOSS
 * *
...
export class BREAKINGFinalAlignment1774073622167 implements MigrationInterface {
  name = 'BREAKINGFinalAlignment1774073622167';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
      ALTER TABLE "import" ALTER COLUMN "driver_id" SET NOT NULL;
    `);
  }
