...
/**
 * INTENT:    Phase 8 of 47 — Column "resource_id" requires backfill before NOT NULL can be enforced
 * TYPE:      DATA
 * RISK:      MEDIUM
 * ROLLBACK:  SAFE
 * *
...
export class DATAFinalAlignment1774073622148 implements MigrationInterface {
  name = 'DATAFinalAlignment1774073622148';
