...
/**
 * INTENT:    Phase 43 of 47 — Enforce NOT NULL on "resource_id" after data is backfilled
 * TYPE:      BREAKING
 * RISK:      HIGH
 * ROLLBACK:  DATA_LOSS
 * *
...
export class BREAKINGFinalAlignment1774073622183 implements MigrationInterface {
  name = 'BREAKINGFinalAlignment1774073622183';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
      ALTER TABLE "import" ALTER COLUMN "resource_id" SET NOT NULL;
    `);
  }
