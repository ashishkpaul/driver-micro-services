...
/**
 * INTENT:    Phase 29 of 47 — Enforce NOT NULL on "seller_order_id" after data is backfilled
 * TYPE:      BREAKING
 * RISK:      HIGH
 * ROLLBACK:  DATA_LOSS
 * *
...
export class BREAKINGFinalAlignment1774073622169 implements MigrationInterface {
  name = 'BREAKINGFinalAlignment1774073622169';
