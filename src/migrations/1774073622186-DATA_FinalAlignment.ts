...
/**
 * INTENT:    Phase 46 of 47 — Column "version" requires backfill before NOT NULL can be enforced
 * TYPE:      DATA
 * RISK:      MEDIUM
 * ROLLBACK:  SAFE
 * *
...
export class DATAFinalAlignment1774073622186 implements MigrationInterface {
  name = 'DATAFinalAlignment1774073622186';
