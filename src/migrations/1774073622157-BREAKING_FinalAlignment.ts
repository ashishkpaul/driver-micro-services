...
/**
 * INTENT:    Phase 17 of 47 — Enforce NOT NULL on "seller_order_id" after data is backfilled
 * TYPE:      BREAKING
 * RISK:      HIGH
 * ROLLBACK:  DATA_LOSS
 * *
...
export class BREAKINGFinalAlignment1774073622157 implements MigrationInterface {
  name = 'BREAKINGFinalAlignment1774073622157';
