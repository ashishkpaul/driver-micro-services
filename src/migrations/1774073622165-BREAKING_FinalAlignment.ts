...
/**
 * INTENT:    Phase 25 of 47 — Enforce NOT NULL on "driver_id" after data is backfilled
 * TYPE:      BREAKING
 * RISK:      HIGH
 * ROLLBACK:  DATA_LOSS
 * *
...
export class BREAKINGFinalAlignment1774073622165 implements MigrationInterface {
  name = 'BREAKINGFinalAlignment1774073622165';
