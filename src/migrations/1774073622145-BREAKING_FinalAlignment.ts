...
/**
 * INTENT:    Phase 5 of 47 — Enforce NOT NULL on "version" after data is backfilled
 * TYPE:      BREAKING
 * RISK:      HIGH
 * ROLLBACK:  DATA_LOSS
 * *
...
export class BREAKINGFinalAlignment1774073622145 implements MigrationInterface {
  name = 'BREAKINGFinalAlignment1774073622145';
