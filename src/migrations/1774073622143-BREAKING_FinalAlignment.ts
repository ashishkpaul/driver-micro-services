...
/**
 * INTENT:    Phase 3 of 47 — Enforce NOT NULL on "updated_at" after data is backfilled
 * TYPE:      BREAKING
 * RISK:      HIGH
 * ROLLBACK:  DATA_LOSS
 * *
...
export class BREAKINGFinalAlignment1774073622143 implements MigrationInterface {
  name = 'BREAKINGFinalAlignment1774073622143';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
      ALTER TABLE "import" ALTER COLUMN "updated_at" SET NOT NULL;
    `);
  }
