...
/**
 * INTENT:    Phase 47 of 47 — Enforce NOT NULL on "version" after data is backfilled
 * TYPE:      BREAKING
 * RISK:      HIGH
 * ROLLBACK:  DATA_LOSS
 * *
...
export class BREAKINGFinalAlignment1774073622187 implements MigrationInterface {
  name = 'BREAKINGFinalAlignment1774073622187';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
      ALTER TABLE "import" ALTER COLUMN "version" SET NOT NULL;
    `);
  }
