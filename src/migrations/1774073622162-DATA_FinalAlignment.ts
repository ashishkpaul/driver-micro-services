...
/**
 * INTENT:    Phase 22 of 47 — Column "seller_order_id" requires backfill before NOT NULL can be enforced
 * TYPE:      DATA
 * RISK:      MEDIUM
 * ROLLBACK:  SAFE
 * *
...
export class DATAFinalAlignment1774073622162 implements MigrationInterface {
  name = 'DATAFinalAlignment1774073622162';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
      -- Backfill: set a safe default for every existing row before enforcing NOT NULL
UPDATE import SET "seller_order_id" = <DEFAULT_VALUE> WHERE "seller_order_id" IS NULL;
    `);
  }
