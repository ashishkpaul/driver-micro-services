...
/**
 * INTENT:    Phase 41 of 47 — Enforce NOT NULL on "last_error" after data is backfilled
 * TYPE:      BREAKING
 * RISK:      HIGH
 * ROLLBACK:  DATA_LOSS
 * *
...
export class BREAKINGFinalAlignment1774073622181 implements MigrationInterface {
  name = 'BREAKINGFinalAlignment1774073622181';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
      ALTER TABLE "import" ALTER COLUMN "last_error" SET NOT NULL;
    `);
  }
