...
/**
 * INTENT:    Phase 16 of 47 — Column "seller_order_id" requires backfill before NOT NULL can be enforced
 * TYPE:      DATA
 * RISK:      MEDIUM
 * ROLLBACK:  SAFE
 * *
...
export class DATAFinalAlignment1774073622156 implements MigrationInterface {
  name = 'DATAFinalAlignment1774073622156';
