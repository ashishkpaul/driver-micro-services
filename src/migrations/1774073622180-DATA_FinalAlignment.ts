...
/**
 * INTENT:    Phase 40 of 47 — Column "last_error" requires backfill before NOT NULL can be enforced
 * TYPE:      DATA
 * RISK:      MEDIUM
 * ROLLBACK:  SAFE
 * *
...
export class DATAFinalAlignment1774073622180 implements MigrationInterface {
  name = 'DATAFinalAlignment1774073622180';
