...
/**
 * INTENT:    Phase 35 of 47 — Enforce NOT NULL on "seller_order_id" after data is backfilled
 * TYPE:      BREAKING
 * RISK:      HIGH
 * ROLLBACK:  DATA_LOSS
 * *
...
export class BREAKINGFinalAlignment1774073622175 implements MigrationInterface {
  name = 'BREAKINGFinalAlignment1774073622175';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
      ALTER TABLE "import" ALTER COLUMN "seller_order_id" SET NOT NULL;
    `);
  }
