...
/**
 * INTENT:    Phase 13 of 47 — Enforce NOT NULL on "last_error" after data is backfilled
 * TYPE:      BREAKING
 * RISK:      HIGH
 * ROLLBACK:  DATA_LOSS
 * *
...
export class BREAKINGFinalAlignment1774073622153 implements MigrationInterface {
  name = 'BREAKINGFinalAlignment1774073622153';
