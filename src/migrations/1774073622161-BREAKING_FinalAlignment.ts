...
/**
 * INTENT:    Phase 21 of 47 — Enforce NOT NULL on "channel_id" after data is backfilled
 * TYPE:      BREAKING
 * RISK:      HIGH
 * ROLLBACK:  DATA_LOSS
 * *
...
export class BREAKINGFinalAlignment1774073622161 implements MigrationInterface {
  name = 'BREAKINGFinalAlignment1774073622161';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
      ALTER TABLE "import" ALTER COLUMN "channel_id" SET NOT NULL;
    `);
  }
