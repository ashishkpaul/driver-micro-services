...
/**
 * INTENT:    Phase 30 of 47 — Column "channel_id" requires backfill before NOT NULL can be enforced
 * TYPE:      DATA
 * RISK:      MEDIUM
 * ROLLBACK:  SAFE
 * *
...
export class DATAFinalAlignment1774073622170 implements MigrationInterface {
  name = 'DATAFinalAlignment1774073622170';
