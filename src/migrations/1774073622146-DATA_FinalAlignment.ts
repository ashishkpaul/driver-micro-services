...
/**
 * INTENT:    Phase 6 of 47 — Column "user_id" requires backfill before NOT NULL can be enforced
 * TYPE:      DATA
 * RISK:      MEDIUM
 * ROLLBACK:  SAFE
 * *
...
export class DATAFinalAlignment1774073622146 implements MigrationInterface {
  name = 'DATAFinalAlignment1774073622146';
