...
/**
 * INTENT:    Phase 37 of 47 — Enforce NOT NULL on "auth_provider" after data is backfilled
 * TYPE:      BREAKING
 * RISK:      HIGH
 * ROLLBACK:  DATA_LOSS
 * *
...
export class BREAKINGFinalAlignment1774073622177 implements MigrationInterface {
  name = 'BREAKINGFinalAlignment1774073622177';
