...
/**
 * INTENT:    Phase 20 of 47 — Column "channel_id" requires backfill before NOT NULL can be enforced
 * TYPE:      DATA
 * RISK:      MEDIUM
 * ROLLBACK:  SAFE
 * *
...
export class DATAFinalAlignment1774073622160 implements MigrationInterface {
  name = 'DATAFinalAlignment1774073622160';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
      -- Backfill: set a safe default for every existing row before enforcing NOT NULL
UPDATE import SET "channel_id" = <DEFAULT_VALUE> WHERE "channel_id" IS NULL;
    `);
  }
