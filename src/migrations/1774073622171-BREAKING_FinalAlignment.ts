...
/**
 * INTENT:    Phase 31 of 47 — Enforce NOT NULL on "channel_id" after data is backfilled
 * TYPE:      BREAKING
 * RISK:      HIGH
 * ROLLBACK:  DATA_LOSS
 * *
...
export class BREAKINGFinalAlignment1774073622171 implements MigrationInterface {
  name = 'BREAKINGFinalAlignment1774073622171';
