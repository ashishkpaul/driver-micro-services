...
/**
 * INTENT:    Phase 36 of 47 — Column "auth_provider" requires backfill before NOT NULL can be enforced
 * TYPE:      DATA
 * RISK:      MEDIUM
 * ROLLBACK:  SAFE
 * *
...
export class DATAFinalAlignment1774073622176 implements MigrationInterface {
  name = 'DATAFinalAlignment1774073622176';
