...
/**
 * INTENT:    Phase 42 of 47 — Column "resource_id" requires backfill before NOT NULL can be enforced
 * TYPE:      DATA
 * RISK:      MEDIUM
 * ROLLBACK:  SAFE
 * *
...
export class DATAFinalAlignment1774073622182 implements MigrationInterface {
  name = 'DATAFinalAlignment1774073622182';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
      -- Backfill: set a safe default for every existing row before enforcing NOT NULL
UPDATE import SET "resource_id" = <DEFAULT_VALUE> WHERE "resource_id" IS NULL;
    `);
  }
