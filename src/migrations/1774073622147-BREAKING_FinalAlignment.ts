...
/**
 * INTENT:    Phase 7 of 47 — Enforce NOT NULL on "user_id" after data is backfilled
 * TYPE:      BREAKING
 * RISK:      HIGH
 * ROLLBACK:  DATA_LOSS
 * *
...
export class BREAKINGFinalAlignment1774073622147 implements MigrationInterface {
  name = 'BREAKINGFinalAlignment1774073622147';
