...
/**
 * INTENT:    Phase 9 of 47 — Enforce NOT NULL on "resource_id" after data is backfilled
 * TYPE:      BREAKING
 * RISK:      HIGH
 * ROLLBACK:  DATA_LOSS
 * *
...
export class BREAKINGFinalAlignment1774073622149 implements MigrationInterface {
  name = 'BREAKINGFinalAlignment1774073622149';
