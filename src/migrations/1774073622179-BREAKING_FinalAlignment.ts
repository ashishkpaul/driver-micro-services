...
/**
 * INTENT:    Phase 39 of 47 — Enforce NOT NULL on "status" after data is backfilled
 * TYPE:      BREAKING
 * RISK:      HIGH
 * ROLLBACK:  DATA_LOSS
 * *
...
export class BREAKINGFinalAlignment1774073622179 implements MigrationInterface {
  name = 'BREAKINGFinalAlignment1774073622179';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
      ALTER TABLE "import" ALTER COLUMN "status" SET NOT NULL;
    `);
  }
