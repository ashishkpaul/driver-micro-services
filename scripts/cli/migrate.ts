...
function buildHeader(opts: HeaderOptions): string {
  ...
  // Auto-inject governance bypass comments for:
  //   BASELINE_  — always contains mixed ops by design
  //   BREAKING_  when isAutoGenerated — machine-generated companion files from `db:new`
